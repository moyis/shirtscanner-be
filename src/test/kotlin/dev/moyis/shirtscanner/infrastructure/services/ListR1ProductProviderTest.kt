...
class ListR1ProductProviderTest {
    ...
    fun `a search on kitsgg returns products`() {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.productLink).isEqualTo(URI("$urlBase/2022-23-France-1-1-Quality-Away-White-Fans-Soccer-Jersey-p1654214.html")) },
            { assertThat(it.price).isEqualTo("US\$ 14.58") },
            { assertThat(it.imageLink).isEqualTo(URI("https://us02-imgcdn.ymcart.com/31229/2022/07/31/3/e/3e595d09fefc0c55.jpg?x-oss-process=image/quality,Q_80/resize,m_lfit,w_220,h_220/interlace,0/format,webp")) },
        )
    }
    ...
    fun `a search on 5boundless returns products`() {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.imageLink).isEqualTo(URI("https://us03-imgcdn.ymcart.com/60655/2022/09/29/c/f/cfbb65c760300f31.jpg?x-oss-process=image/quality,Q_90/auto-orient,1/resize,m_lfit,w_500,h_500/format,webp")) },
        )
    }
    ...
    fun `a search on grkits returns products`() {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.productLink).isEqualTo(URI("$urlBase/2024-Brazil-Blue-Concept-Edition-Player-Version-Soccer-Jersey-p1467478.html")) },
            { assertThat(it.price).isEqualTo("US\$ 20.00") },
            { assertThat(it.imageLink).isEqualTo(URI("https://us03-imgcdn.ymcart.com/97006/2023/12/24/4/3/43074b6d1a448047.jpg?x-oss-process=image/quality,Q_90/auto-orient,1/resize,m_lfit,w_210,h_210")) },
        )
    }
    ...
    fun `a search on gkkoc returns products`() {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.productLink).isEqualTo(URI("$urlBase/2023-Argentina-Blue-Special-Edition-Player-Version-Soccer-Jersey-p22397884.html")) },
            { assertThat(it.price).isEqualTo("US\$ 16.00") },
            { assertThat(it.imageLink).isEqualTo(URI("https://us03-imgcdn.ymcart.com/95755/2023/06/22/c/c/ccca7cd379f8be53.png?x-oss-process=image/quality,Q_90/auto-orient,1/resize,m_lfit,w_220,h_220")) },
        )
    }
    ...
    fun `a search on jeofc1 returns products`() {
        ...
        assertThat(result.products).singleElement().satisfies(
            { assertThat(it.name).isEqualTo("2023 Argentina Blue Special Edition Player Version Soccer Jersey") },
            { assertThat(it.productLink).isEqualTo(URI("$urlBase/2023-Argentina-Blue-Special-Edition-Player-Version-Soccer-Jersey-p22397840.html")) },
            { assertThat(it.price).isEqualTo("US\$ 16.00") },
            { assertThat(it.imageLink).isEqualTo(URI("https://us03-imgcdn.ymcart.com/81221/2023/06/22/f/6/f6fa467e08d6edd2.png?x-oss-process=image/quality,Q_90/auto-orient,1/resize,m_lfit,w_220,h_220")) },
        )
    }
    ...
    fun `a search on jjsport returns products`() {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.imageLink).isEqualTo(URI("https://us03-imgcdn.ymcart.com/70745/2024/01/05/6/7/67a726ab5558f392.jpg?x-oss-process=image/quality,Q_90/auto-orient,1/resize,m_lfit,w_500,h_500")) },
        )
    }
    ...
    fun `a search on kegaoo returns products`() {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.imageLink).isEqualTo(URI("https://us01-imgcdn.ymcart.com/26617/2023/12/28/a/2/a24790c7601ceeba.jpg?x-oss-process=image/quality,Q_90/resize,m_lfit,w_210,h_210/interlace,0/auto-orient,0")) },
        )
    }
    ...
    fun `a search on kotofanss returns products`() {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.imageLink).isEqualTo(URI("https://us03-imgcdn.ymcart.com/45427/2023/12/25/f/0/f0b1beda0b7f3f2f.jpg?x-oss-process=image/quality,Q_90/auto-orient,1/resize,m_lfit,w_220,h_220")) },
        )
    }
    ...
    fun `a search on soccer03 returns products`() {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.imageLink).isEqualTo(URI("https://us03-imgcdn.ymcart.com/43872/2024/01/05/a/5/a5e145887b0817d4.jpg?x-oss-process=image/quality,Q_90/resize,m_lfit,w_500,h_500/interlace,0/auto-orient,0")) },
        )
    }
    ...
    fun `a search on fofoshop returns products`() {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.productLink).isEqualTo(URI("$urlBase/22-23-Argentina-Away-World-Cup-Jersey-Fans-Version-1-1-Quality-p2092229.html")) },
            { assertThat(it.price).isEqualTo("US\$ 15.90") },
            { assertThat(it.imageLink).isEqualTo(URI("https://us03-imgcdn.ymcart.com/51459/2022/09/05/f/f/ff56230aa700a900.jpg?x-oss-process=image/quality,Q_90/auto-orient,1/resize,m_lfit,w_220,h_220")) },
        )
    }
    ...
    fun `a search on aclotzone returns products`() {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.imageLink).isEqualTo(URI("https://cdn.staticsab.com/50294/2022/03/28/7/2/721aef82ad2840af.png?x-oss-process=image/quality,Q_80/resize,m_lfit,w_500,h_500/interlace,0/auto-orient,0/format,jpg")) },
        )
    }
