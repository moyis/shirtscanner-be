...
class DefaultFetcherTest {
    ...
    @Test
    fun `a search on gkkoc returns products`(wmRuntimeInfo: WireMockRuntimeInfo) {
        val q = "argentina"
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.productLink).isEqualTo("${wmRuntimeInfo.httpBaseUrl}/2023-Argentina-Blue-Special-Edition-Player-Version-Soccer-Jersey-p22397884.html") },
    ...
    fun `a search on jeofc1 returns products`(wmRuntimeInfo: WireMockRuntimeInfo) {
        ...
        assertThat(result.products).singleElement().satisfies(
            { assertThat(it.name).isEqualTo("2023 Argentina Blue Special Edition Player Version Soccer Jersey") },
            { assertThat(it.productLink).isEqualTo("${wmRuntimeInfo.httpBaseUrl}/2023-Argentina-Blue-Special-Edition-Player-Version-Soccer-Jersey-p22397840.html") },
            { assertThat(it.price).isEqualTo("US\$ 16.00") },
    ...
    fun `a search on jjsport returns products`(wmRuntimeInfo: WireMockRuntimeInfo) {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.productLink).isEqualTo("${wmRuntimeInfo.httpBaseUrl}/Argentina-2024-Copa-America-Home-Man-Jersey-p25179475.html") },
    ...
    fun `a search on kegaoo returns products`(wmRuntimeInfo: WireMockRuntimeInfo) {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.productLink).isEqualTo("${wmRuntimeInfo.httpBaseUrl}/06-07-Argentina-Away-Retro-Jersey-Thailand-Quality-p1048681.html") },
    ...
    fun `a search on kotofanss returns products`(wmRuntimeInfo: WireMockRuntimeInfo) {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.productLink).isEqualTo("${wmRuntimeInfo.httpBaseUrl}/Argentina-Home-Fans-1-1-24-25-p2445891.html") },
    ...
    fun `a search on soccer03 returns products`(wmRuntimeInfo: WireMockRuntimeInfo) {
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.productLink).isEqualTo("${wmRuntimeInfo.httpBaseUrl}/Argentina-2024-UEFA-Champions-League-Home-Man-Jersey-p621694.html") },
    ...
    @Test
    fun `a search on fofoshop returns products`(wmRuntimeInfo: WireMockRuntimeInfo) {
        val q = "argentina"
        ...
        assertThat(result.products).singleElement().satisfies(
            ...
            { assertThat(it.productLink).isEqualTo("${wmRuntimeInfo.httpBaseUrl}/22-23-Argentina-Away-World-Cup-Jersey-Fans-Version-1-1-Quality-p2092229.html") },
